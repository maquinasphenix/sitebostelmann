...
import { Calendar, MapPin, Users, Instagram, ExternalLink, Bike } from 'lucide-react';
import { Button } from './ui/button';
import { FloralCorner, FloralDivider, DelicateFlower } from './DecorativeElements';

export function CyclingEvent() {
  return (
    <section id="evento-ciclismo" className="py-20 lg:py-32 bg-gradient-to-br from-background via-white to-background relative overflow-hidden">
      {/* Decorative Elements */}
